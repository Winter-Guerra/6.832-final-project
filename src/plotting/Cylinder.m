 function [handle] = Cylinder(X1,X2,r,n,cyl_color,closed,lines,alpha)
%
...
set(Cylinder,'FaceColor',cyl_color,'FaceAlpha',alpha)
if closed==1
...
if lines==0
    ...
    set(EndPlate2,'EdgeAlpha',0)
end
    
handle = hgtransform('Parent',gca);
set(Cylinder,'Parent',handle)
set(EndPlate1,'Parent',handle)
set(EndPlate2,'Parent',handle)
end